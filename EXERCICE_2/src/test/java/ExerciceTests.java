...
public class ExerciceTests {
    ...
    public void listeVide() {
        ...
        //when
        final var actual = exercice.compteNbValeursInfZeroEtAjouteValeursSup(1, listeEntiers);
        //ASSERT
    ...
    public void listeAvecPlusieursEntiersNegatifsEtGrandA1() {
        ...
        listeEntiers.add(-33);
        //when
        final var actual = exercice.compteNbValeursInfZeroEtAjouteValeursSup(6, listeEntiers);
        //then
        var firstResult = actual.entrySet().iterator().next();
    ...
    public void listeAvecBeaucoupEntiersNegatifsEtPetitA1() {
        ...
        listeEntiers.add(-33);
        //when
        final var actual = exercice.compteNbValeursInfZeroEtAjouteValeursSup(2, listeEntiers);
        //then
        var firstResult = actual.entrySet().iterator().next();
        Assertions.assertThat(firstResult.getKey()).isEqualTo(1);
        //2e verification:  que contient la chaine de caractère?
